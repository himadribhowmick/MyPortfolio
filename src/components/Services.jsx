...
const services = [
  { title: 'UI/UX', desc: 'User flow, wireframes and prototypes', icon: <FiLayout size={22}/> },
  { title: 'Web Design', desc: 'Modern responsive websites', icon: <FiMonitor size={22}/> },
  { title: 'App Design', desc: 'Mobile app UX & UI', icon: <FiSmartphone size={22}/> },
  { title: 'Graphic Design', desc: 'Branding and marketing materials', icon: <FiPenTool size={22}/> },
]
...
export default function Services() {
  return (
    <section id="services" className="max-w-6xl mx-auto px-6 md:px-8 py-16">
      ...
      <h3 className="text-3xl font-bold text-center mb-4 text-gray-900 dark:text-white">Services</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {services.map((s) => (
          <div key={s.title} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition">
            {/* Card icon */}

  ...
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 py-10 flex flex-col items-center gap-6">
        ...
        {/* Navigation */}
        <nav className="flex flex-wrap justify-center gap-6 text-gray-700 dark:text-gray-300 text-sm">
        ...
        <div className="flex gap-4 text-gray-700 dark:text-gray-300 text-lg">
          <a href="https://www.facebook.com/himadrihimuofficialpage/" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 dark:hover:text-orange-400"><FaFacebookF /></a>
          <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 dark:hover:text-orange-400"><FaTwitter /></a>
          <a href="https://www.instagram.com/himadri_himu55/" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 dark:hover:text-orange-400"><FaInstagram /></a>
          <a href="https://www.linkedin.com/in/himadri-bhowmick-89b7b525b/" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 dark:hover:text-orange-400"><FaLinkedinIn /></a>
        </div>
      </div>
      ...
      <div className="bg-gray-700 dark:bg-gray-800 text-gray-200 dark:text-gray-300 text-center py-4 text-sm transition-colors duration-300">
        © 2025 <span className="text-orange-500 font-semibold">Himadri Bhowmick</span> All Rights Reserved, Inc.
      </div>
    </footer>
  );
}

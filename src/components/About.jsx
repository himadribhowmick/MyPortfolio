    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex flex-col items-center justify-center min-h-[670px]">
          ...
          <div className="absolute top-[50px] lg:top-[50px] left-1/2 -translate-x-[60%] w-[200px] h-[40px] bg-orange-500/60 rounded-sm z-50 animate-glow-pulse"></div>
          ...
          <div className="relative w-96 h-96 rounded-[60%] z-10">
            <div
              ...
              style={{
                background:
                  "conic-gradient(from 140deg, rgba(255, 102, 0, 0.6), rgba(181, 168, 160, 0.6), rgba(176, 205, 179, 0.95))",
              }}
            >
        ...
        <div className="text-left order-first lg:order-last">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-10">
            I’m Himadri Bhowmick, a passionate Frontend Software Developer with
            a strong interest in building clean, responsive, and user-friendly
            web interfaces. I recently completed my Bachelor of Science in
            Computer Science and Engineering (CSE) from Bangladesh Army
            International University of Science and Technology (BAIUST).
            Currently, I’m pursuing an internship at Bakhrabad Gas Distribution
            Company Limited (BGDCL), where I’m gaining practical experience in
            real-world software development. My technical expertise includes
            HTML, CSS (Tailwind CSS), and JavaScript (React) — technologies I
            use to craft modern, efficient, and engaging web applications. I’m
            always eager to learn new tools, improve my skills, and take on
